Feature: US033_Organization - Organization kullanicisi olarak anasayfada kurslari gorebilmek, bilgi alabilmek ve kurs secebilecegim bir sayfa olmasini istiyorum
  ...
  @courses @smoke @US033 @organization @TC01
  ...
  @courses @smoke @US033 @organization @TC02
  ...
  @courses @functional @US033 @organization @TC03
  ...
  @courses @functional @US033 @organization @TC04
  ...
  @courses @functional @US033 @organization @TC05
  ...
  @courses @functional @US033 @organization @TC06
  ...
  @courses @functional @US033 @organization @TC07
  ...
  @courses @e2e @US033 @organization @TC08
