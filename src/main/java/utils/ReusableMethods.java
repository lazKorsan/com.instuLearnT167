...
public class ReusableMethods {
    ...
    public static WebElement highLightToElement(WebElement element) {
        ...
        // Elementi vurgula: sarı arka plan, 2px kırmızı kenarlık
        js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", element);

        // Orijinal stile geri döndürmek için (opsiyonel ve önerilen):
        // try {
        //     Thread.sleep(500); // Vurgulamanın görünmesi için kısa bir bekleme
